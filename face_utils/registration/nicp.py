...
def non_rigid_icp(source, target, eps=1e-3, PerNrom_type=None,Para_Nrom=None,landmark_group=None,
    ...
    generator = non_rigid_icp_generator(source, target, eps=eps,
                                        ...
                                        verbose=verbose,PerNrom_type=PerNrom_type,
                                        Para_Nrom=Para_Nrom,
...
def non_rigid_icp_generator(source, target, eps=1e-3,PerNrom_type=None,Para_Nrom=0.3,
                            stiffness_weights=None, data_weights=None,
                            landmark_group=None, landmark_weights=None,
    ...
    for i, (alpha, beta, gamma) in enumerate(zip(stiffness_weights,
        ...
        while True:  # iterate until convergence
            ...
            if PerNrom_type=="Percentage":
                print("Para_Nrom:",Para_Nrom)
                threshold_nrom=np.sort(w_i_n)[int(len(w_i_n)*Para_Nrom)]#0.3
            elif PerNrom_type=="Constant":
                threshold_nrom=Para_Nrom  #0.9
            #print("threshold_nrom::", threshold_nrom )
                
            w_i_n=w_i_n>threshold_nrom
            # 3. Self-intersection
